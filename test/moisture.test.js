...
describe('moisture functions', () => {
  describe('moistureSensor()', () => {
    it('Should generate an error when all values are out of range', () => {
      ...
      const result = conversions.moistureSensor(
        readings,
        physical,
        multiplier,
        precision,
  ...
  describe('soilMoistureSensorAverage()', () => {
    it('Should generate an error when all values are out of range', () => {
      ...
      const result = conversions.soilMoistureSensorAverage(
        readings,
        physical,
        multiplier,
        precision,
  ...
  describe('soilSalinitySensorAverage()', () => {
    it('Should generate an error when all values are out of range', () => {
      ...
      const result = conversions.soilSalinitySensorAverage(
        readings,
        physical,
        multiplier,
        precision,
  ...
  describe('soilTemperatureSensorAverage()', () => {
    it('Should generate an error when all values are out of range', () => {
      ...
      const result = conversions.soilTemperatureSensorAverage(
        readings,
        physical,
        multiplier,
        precision,
