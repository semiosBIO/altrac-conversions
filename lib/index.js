    ...
    case 'flowCumulative':
      {
        ...
        returnValue = pulseDiff(readingCurrent[valueKey], readingLast[valueKey], readingCurrent[_flowTime2] || readingCurrent.date, readingLast[_flowTime2] || readingLast.date);
