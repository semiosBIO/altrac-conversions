...
const timePick = function (readingCurrentFlowTime, readingCurrentDate, readingLastFlowTime, readingLastDate) {
  /*
  ...
  */
  ...
  var timeDiffSecondsFlowTime = readingCurrentFlowTime - readingLastFlowTime;
  var timeDiffDate = (new Date(readingCurrentDate).getTime() - new Date(readingLastDate).getTime()) / 1000;
  ...
  /*
    ...
    If the difference of timestamp value from flow time key is greater than 30 seconds (make it safe),
    ...
    case 'pumpOutput':
      {
        ...
        var [currentTime, lastTime] = timePick(readingCurrent[flowTime], readingCurrent.date, readingLast[flowTime], readingLast.date);
        returnValue = pumpOutput(readingCurrent[valueKey], readingLast[valueKey], currentTime, lastTime, multiplierValue);
      }
      break;
    ...
    case 'flowRate':
      {
        ...
        var [currentTime, lastTime] = timePick(readingCurrent[_flowTime], readingCurrent.date, readingLast[_flowTime], readingLast.date);
        returnValue = pumpOutput(readingCurrent[valueKey], readingLast[valueKey], currentTime, lastTime, multiplierValue);
      }
      break;
    ...
    case 'flowRateLiters':
      {
        ...
        var [currentTime, lastTime] = timePick(readingCurrent[_flowTime2], readingCurrent.date, readingLast[_flowTime2], readingLast.date);
        returnValue = pumpOutput(readingCurrent[valueKey], readingLast[valueKey], currentTime, lastTime, multiplierValue);
      }
      break;
    ...
    case 'flowCumulative':
      {
        ...
        var [currentTime, lastTime] = timePick(readingCurrent[_flowTime3], readingCurrent.date, readingLast[_flowTime3], readingLast.date);
        returnValue = pulseDiff(readingCurrent[valueKey], readingLast[valueKey], currentTime, lastTime);
    ...
    case 'flowCumulativeLiters':
      {
        ...
        var [currentTime, lastTime] = timePick(readingCurrent[_flowTime4], readingCurrent.date, readingLast[_flowTime4], readingLast.date);
        returnValue = pulseDiff(readingCurrent[valueKey], readingLast[valueKey], currentTime, lastTime);
        returnValue *= multiplierValue;
      }
      break;
...
var pressureFourToTwenty = function pressureFourToTwenty(valueKey, value, physical) {
  var returnValue = 0;
  ...
  if (valueKey === 'R1F') {
    returnValue = map(value, physical.r1FMin || 0, physical.r1FMax || 100, 4, 20);
  } else if (valueKey === 'R2F') {
    returnValue = map(value, physical.r2FMin || 0, physical.r2FMax || 100, 4, 20);
  } else if (valueKey === '142' || valueKey === '143') {
    returnValue = map(value, physical.r2FMin || 0, physical.r2FMax || 100, // 1953.125 is equal to 4mA for valve = (1953.125 / 10000) * 2.048 * 10 = 4
    1953.125, // 9765.625 is equal to 20mA for valve = (9765.625 / 10000) * 2.048 * 10 = 20
    9765.625);
  } else {
    return 'ERR';
  }
...
module.exports = {
  ...
  pressureFourToTwenty: pressureFourToTwenty,
